(() => {
  ...
  function renderResult(result) {
    ...
    resultPrizeName.textContent = isParticipation ? "" : result.title;
    resultPrizeName.hidden = isParticipation;
    ...
    resultPrizeBlock.hidden = isParticipation;
    ...
    if (isSpecialPrize) {
    ...
    } else if (!isParticipation && result.image) {
      ...
      resultPrizeImage.removeAttribute("src");
      resultPrizeImage.alt = "";
      resultTextOnly.hidden = false;
      resultTextOnly.textContent = result.textOnly || result.title;
    } else {
      resultPrizeImage.hidden = true;
      resultPrizeImage.removeAttribute("src");
      resultPrizeImage.alt = "";
